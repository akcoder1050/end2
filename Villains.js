class   Villains{
    ...
    constructor(){
        ...
        this.Thanos = Bodies.rectangle( 1420 , 1035 , 225, 500 , options)
        World.add(world , this.Thanos);
        this.image1=loadImage("images/Thanos.PNG")

        this.BounsyAliens1 = Bodies.rectangle( 1800 , 250 , 100 , 100 , {isStatic:true,restitution:2,density:1})
        World.add(world , this.BounsyAliens1);
        this.image2=loadImage("images/BounsyAliens1.PNG")
       
        this.BounsyAliens2 = Bodies.rectangle( 1800 , 1400 , 100 , 100 ,  {isStatic:false,restitution:2,density:1})
